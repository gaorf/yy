...
<div class="page-container">
	<div class="cl pd-5 bg-1"> 
		<span class="l">
			...
			<a href="<?php echo U('Company/addCompany');?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加企业</a>
		</span>
		<span class="r"></span>
	</div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
				...
				<td></td>
				<td><?php echo ($vo["province"]); echo ($vo["city"]); echo ($vo["district"]); ?></td>
				<td class="text-l"><?php echo ($vo["company_desc"]); ?></td>
				<td class="td-status"><?php echo ($vo["status"]); ?></td>
				<td class="td-manage">
					<a title="编辑" href="<?php echo U('eidtCompany',array('id'=>$vo['id']));?>" class="ml-5" style="text-decoration:none">编辑</a>
					<a title="删除" href="<?php echo U('deleteCompany',array('id'=>$vo['id']));?>" onclick="return layer_del(this);" class="ml-5" style="text-decoration:none">删除</a>
				</td>
...
<script type="text/javascript" src="/yy/Public/Statics/lib/datatables/1.10.0/jquery.dataTables.min.js"></script> 
<script>
$(function(){
